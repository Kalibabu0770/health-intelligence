...
const AYUSHHealthSystem: React.FC = () => {
    ...
    const renderNav = () => {
        ...
        return (
            <div className="flex bg-white/80  border border-slate-200 p-1.5 rounded-xl shadow-xl shadow-slate-200/50 mb-8 w-fit mx-auto sticky top-0 z-50">
                {steps.map((s) => (
                    <button
                        key={s.id}
                ...
                {step === 1 && (
                    <div className="h-full w-full grid grid-cols-12 gap-3 animate-in fade-in slide-in-from-bottom-5 duration-700">
                        ...
                        <div className="col-span-12 lg:col-span-3 flex flex-col h-full gap-3">
                            <div className="flex-1 bg-white rounded-xl border border-slate-200 p-5 flex flex-col items-center justify-center text-center shadow-lg shadow-slate-200/40 relative overflow-hidden group">
                        ...
                        <div className="col-span-12 lg:col-span-5 flex flex-col h-full">
                            <div className="flex-1 bg-white rounded-xl border border-slate-200 p-5 flex flex-col shadow-lg shadow-slate-200/40 min-h-0">
                                ...
                                <div className="flex-1 overflow-y-auto custom-scrollbar pr-1 space-y-2">
                                    {ayushResult?.regional_seasonal_risks?.map((risk: any, i: number) => (
                                        <div key={i} className="bg-slate-50/50 border border-slate-100 p-3 rounded-xl flex items-center gap-4 hover:bg-white hover:border-emerald-200 transition-all group cursor-default">
                ...
                {step === 2 && (
                    <div className="h-full w-full flex flex-col gap-5 animate-in slide-in-from-right-5 duration-700">
                        <div className="grid grid-cols-12 gap-5 flex-1 min-h-0">
                            ...
                            <div className="col-span-12 lg:col-span-8 bg-white rounded-xl border border-slate-200 p-8 flex flex-col shadow-xl shadow-slate-200/50 min-h-0">
                    ...
                    <div className="h-full w-full grid grid-cols-12 gap-5 animate-in zoom-in-95 duration-700">
                            ...
                            <div className="bg-white rounded-xl border border-slate-200 p-6 flex flex-col shadow-xl shadow-slate-200/50 flex-1 min-h-0">
                                ...
                                <div className="space-y-6 mb-8">
                                    <div className="relative group">
                                        <input
                                            ...
                                            className="w-full bg-slate-50 border-2 border-slate-100 p-5 rounded-xl font-black text-[11px] uppercase placeholder:text-slate-300 focus:bg-white focus:border-emerald-500 outline-none transition-all shadow-sm"
                                        />
                                        <button
                                ...
                                {selectedPatient ? (
                                    <div className="flex-1 overflow-y-auto custom-scrollbar pr-2 space-y-6 animate-in slide-in-from-top-2 duration-500">
                                        ...
                                        <div className="bg-emerald-50/50 p-6 rounded-xl border border-emerald-100 shadow-sm relative overflow-hidden">
                        ...
                        <div className="col-span-12 lg:col-span-8 flex flex-col h-full min-h-0">
                            <div className="flex-1 bg-white rounded-xl border border-slate-200 p-8 flex flex-col shadow-xl shadow-slate-200/50 min-h-0">
                                ...
                                {/* Chat / Voice Area */}
                                <div className="flex-1 overflow-hidden flex flex-col bg-slate-50/50 rounded-xl border border-slate-100 relative">
                                    <div className="flex-1 overflow-y-auto custom-scrollbar p-8 space-y-6">
                                        ...
                                        {transcript && !clinicalAnalysis && (
                                            <div className="bg-white/80 p-6 rounded-xl border border-emerald-200 shadow-lg max-w-lg mx-auto border-dashed animate-in slide-in-from-bottom-5">
                                    ...
                                    <div className="p-8 bg-white border-t border-slate-100 shrink-0 flex items-center gap-6">
                                        ...
                                        <div className="flex-1 bg-white border-2 border-slate-100 rounded-xl p-4 flex items-center group focus-within:border-emerald-500 transition-all">
                                            <textarea
                                                value={transcript}
